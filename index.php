...
<html>
  ...
  <meta name="author"      content="LangSwap Inc." />
    ...
    <style>
      ...
      .wrap{
        background-image: url('https://storage.needpix.com/rsynced_images/blue-2852879_1280.jpg');
      }
      .wrap2{
...
<img src="https://upload.wikimedia.org/wikipedia/commons/d/d5/Avatar-middle.png" alt="Avatar" class="avatar">
<h1 style="text-align:center">Create Account</h1>
</div>
<center><p id = "error" style = "color: red; width: 300px; background-color: #F9E1E1; border-radius: 10px 10px 10px 10px;"></p></center>
<div class="container">
...
<label for = "lang"><b>Native Language:</b></label> 
  <select style = "display: inline;" class = "ro" name = "lang1" id = "lang1"><option value="English" class="emoji"  selected>English</option>
				<option value="Afrikaans" class="emoji"> Afrikaans</option>
				<option value="Albanian" class="emoji" >Albanian</option>
				<option value="Amharic" class="emoji" >Amharic</option>
				<option value="Arabic" class="emoji" >Arabic</option>
				<option value="Armenian" class="emoji" >Armenian  </option>
				<option value="Basque" class="emoji" >Basque</option>
				<option value="Bengali" class="emoji" >Bengali</option>
				<option value="Byelorussian" class="emoji" >Byelorussian</option>
				<option value="Burmese" class="emoji" >Burmese</option>
				<option value="Bulgarian" class="emoji" >Bulgarian</option>
        <option value="Cantonese" class="emoji" >Cantonese</option>
				<option value="Catalan" class="emoji" >Catalan</option>
				<option value="Czech" class="emoji" >Czech</option>
        <option value="Croatian" class="emoji" >Croatian</option>
        <option value="Danish" class="emoji" >Danish</option>
        <option value="Dari" class="emoji" >Dari</option>
        <option value="Dzongkha" class="emoji" >Dzongkha</option><option value="DU" class="emoji" >Dutch</option>
        <option value="Esperanto" class="emoji" >Esperanto</option>
        <option value="Estonian" class="emoji" >Estonian</option>
        <option value="Faroese" class="emoji" >Faroese</option>
        <option value="Farsi" class="emoji" >Farsi</option>
        <option value="Finnish" class="emoji" >Finnish</option>
        <option value="French" class="emoji" >French</option>
        <option value="Gaelic" class="emoji" >Gaelic</option>
        <option value="Galician" class="emoji" >Galician</option>
        <option value="German" class="emoji" >German</option>
        <option value="Greek" class="emoji" >Greek</option>
        <option value="Hebrew" class="emoji" >Hebrew</option>
        <option value="Hindi" class="emoji" >Hindi</option>
        <option value="Hungarian" class="emoji" >Hungarian</option>
        <option value="Icelandic" class="emoji" >Icelandic</option>
        <option value="Indonesian" class="emoji" >Indonesian</option>
        <option value="Inuktitut" class="emoji" >Inuktitut (Eskimo)</option>
        <option value="Japanese" class="emoji" >Japanese</option>
        <option value="Khmer" class="emoji" >Khmer</option>
        <option value="Korean" class="emoji" >Korean</option>
        <option value="Kurdish" class="emoji" >Kurdish</option>
        <option value="Laotian" class="emoji" >Laotian</option>
        <option value="Latvian" class="emoji" >Latvian</option>
        <option value="Lappish" class="emoji" >Lappish</option>
        <option value="Lithuanian" class="emoji" >Lithuanian</option>
        <option value="Macedonian" class="emoji" >Macedonian</option>
        <option value="Malay" class="emoji" >Malay</option>
        <option value="Maltese" class="emoji" >Maltese</option>
        <option value="Nepali" class="emoji" >Nepali</option>
        <option value="Norwegian" class="emoji" >Norweigian</option>
        <option value="Pashto" class="emoji" >Pashto</option>
        <option value="Polish" class="emoji" >Polish</option>
        <option value="Portuguese" class="emoji" >Portuguese</option>
        <option value="Romanian" class="emoji" >Romanian</option>
        <option value="Russian" class="emoji" >Russian</option>
        <option value="Scots" class="emoji" >Scots</option>
        <option value="Serbian" class="emoji" >Serbian</option>
        <option value="Slovak" class="emoji" >Slovak</option>
        <option value="Slovenian" class="emoji" >Slovenian</option>
        <option value="Somali" class="emoji" >Somali</option>
        <option value="Spanish" class="emoji">Spanish</option>
        <option value="Swedish" class="emoji" >Swedish</option>
        <option value="Swahili" class="emoji" >Swahili</option>
        <option value="Tagalog-Filipino" class="emoji" >Tagalog-Filipino</option>
        <option value="Tajik" class="emoji" >Tajik</option>
        <option value="Tamil" class="emoji" >Tamil</option>
        <option value="Thai" class="emoji" >Thai</option>
        <option value="Tibetan" class="emoji" >Tibetan</option>
        <option value="Tigrinya" class="emoji" >Tigrinya</option>
        <option value="Tongan" class="emoji" >Tongan</option>
        <option value="Turkish" class="emoji" >Turkish</option>
        <option value="Turkmen" class="emoji" >Turkmen</option>
        <option value="Ukranian" class="emoji" >Ukrainian</option>
        <option value="Urdu" class="emoji" >Urdu</option>
        <option value="Uzbek" class="emoji" >Uzbek</option>
        <option value="Vietnamese" class="emoji" >Vietnamese</option>
        <option value="Welsh" class="emoji" >Welsh</option>
        </select><br><br>
  <label for = "lang2"><b>Learn Language:</b></label> 
<select style = "display: inline;" class = "ro" name = "lang2" id = "lang1"><option value="English" class="emoji">English</option>
				<option value="Afrikaans" class="emoji"> Afrikaans</option>
				<option value="Albanian" class="emoji" >Albanian</option>
				<option value="Amharic" class="emoji" >Amharic</option>
				<option value="Arabic" class="emoji" >Arabic</option>
        ...
        <option value="Slovenian" class="emoji" >Slovenian</option>
        <option value="Somali" class="emoji" >Somali</option>
        <option value="Spanish" class="emoji" selected>Spanish</option>
        <option value="Swedish" class="emoji" >Swedish</option>
        <option value="Swahili" class="emoji" >Swahili</option>
        <option value="Tagalog-Filipino" class="emoji" >Tagalog-Filipino</option>
        <option value="Tajik" class="emoji" >Tajik</option>
        ...
        <!--Change if needed-->
        <textarea name = "desc" placeholder = "Description (Optional)" class = "pkpk" style = "height: 200px; resize: vertical;"></textarea>
...
<input type="password" placeholder="Enter Password" name="psword" class = "pkpk" id = "pword" Title = "Please fill out this field">
<button class = "ok" type="submit" name = "login">Log-in</button>
<!--<input type="checkbox" style="margin:26px 30px;"> Remember me-->
<a href="forgetPass.php" style="text-decoration:none; float:right; margin-right:34px; margin-top:26px; color: blue;" class = "pq">Forgot Password?</a>
</div>

</form>

</div>
  <img src = "https://media.defense.gov/2016/Jul/18/2001576507/-1/-1/0/160715-F-RN654-022.JPG" style = "float: right; height: 375px; width: 30%;" alt = "Different Cultures">
  <!--
  <p style = "display: inline; float: right; font-size: 25pt; margin-right: 50pt; text-align: center; font-family: serif; color: blue; line-height: 180%;"><b>Exchange <br>languages <br>with <br>others!</b></p>
  <p></p>-->
  
  <div class = "boc">
  <p style = "text-align: center; font-size: 24pt;" id = "abouT"><b>About</b></p><p style = "font-size: 16pt; font-family: Averia Libre;">Through LangSwap, people can exchange languages with each other through text and call. Through LangSwap people can learn about other peoples cultures and languages while at the same time making more online friendship. Also, on LangSwap there is a shop where people can buy and sell books in different languages. If you want to connect to your shop account you need to enter additional information based on your card and age. If you have questions, feel free to contact us, and we hope that you enjoy our program. Our main goal is to for people to exchange their languages with others, in order to have a better understanding of othe language they want to learn while at the same time share their knowledge with others. <b>You can only exchange one language. </b>Hope you enjoy! </p>  
  </div>
  <center>
  <button class = "buro" onclick = "locateO();"><b>Find a friend or person</b> &rarr;</button><br><br>
...
<div class="card" style = "float: right;">
  <img src="https://c1.wallpaperflare.com/preview/235/157/133/restaurant-people-eating-socializing.jpg" alt="Exchange with others" style="width:100%; height: 300px;">
  <h1>Socialize with Others Over Text and Video</h1><br>
  <p>You will have the opportunity to meet new people and learn their language through call and text!</p><br>
  <p><button onclick = "soo();">Learn More</button></p>
</div>
<div class="card">
  <img src="https://cdn.pixabay.com/photo/2017/05/26/11/10/language-2345801_1280.jpg" alt="Exchange with others" style="width:100%; height: 300px;">
  <h1>Shop Online for Language Books (Buy/Sell)</h1><br>
  <p>Buy and sell language books at our language book shop! Books based on different languages.</p><br>
...
<div class = "action" onclick = "actionToggle();" title = "Share on social media">
      <span>+</span>
      <ul>
        </li><a href = "https://www.facebook.com/" class = "oX" target = "_blank"><img src = "https://upload.wikimedia.org/wikipedia/commons/c/cd/Facebook_logo_%28square%29.png" class = "smA">Share on Facebook</a></li><hr>
        </li><a href= "https://twitter.com/explore" class = "oX" target = "_blank"><img src = "https://t0.rbxcdn.com/11b35c367bedd6b8a9615784657366e2" style = "width: 40px; height: 40px;margin: -7px;">Share on Twitter</a></li><hr>
        </li><a href = "https://www.instagram.com/" class = "oX" target = "_blank"><img src = "https://upload.wikimedia.org/wikipedia/commons/9/96/Instagram.svg" class = "smA">Share on Instagram</a></li><hr>
        </li><a href = "https://www.pinterest.com/" class = "oX"target = "_blank"><img src = "https://upload.wikimedia.org/wikipedia/commons/0/08/Pinterest-logo.png" class = "smA">Share on Pinterest</a></li><hr>
        </li><a href = "https://www.linkedin.com/" class = "oX" target = "_blank"><img src = "https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png" class = "smA">Share on Linkedin</a></li>
      </ul>
    </div>
    </center>
    -->
...
<div class="container2"><center><input type = "text" class = "kfo" autocomplete = "false" Title = "Enter email..." placeholder = "Enter email..." id = "emil" name = "emil"></center><br>
...
function checkforblank(){
  var errormessage = "";
    ...
    // if (document.getElementById("pass").value != ""){
    //   if (document.getElementById("pass").innerHTML.length < 8){
...
function checkforblankT(){
  var errormessaget = "";
    if (document.getElementById("username").value == ""){
      errormessaget += "No username entered <br>";
    ...
    if (document.getElementById("pword").value == ""){
      ...
      document.getElementById("pword").style.borderColor = "lightgray";
    }
    if (errormessaget != ""){
